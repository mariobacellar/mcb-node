...
app.use(express.static('public/bp-garcon'))
// ====================== CONFIG ======================
...
app.get('/dashboard-garcon-login', function (req, res) {
    //res.render("dashboard-garcon");
    res.sendFile(__dirname + '/public/bp-garcon/login.html');

});
app.get('/dashboard-garcon-index', function (req, res) {
    //res.render("dashboard-garcon");
    res.sendFile(__dirname + '/public/bp-garcon/index.html');

});
app.get('/dashboard-garcon-register', function (req, res) {
    //res.render("dashboard-garcon");
    res.sendFile(__dirname + '/public/bp-garcon/register.html');
