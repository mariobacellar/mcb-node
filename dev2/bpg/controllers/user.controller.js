...
exports.create = (req, res) => {
    ...
    new User({
	    ...
	    addredd.city    : req.body.city     	,
	    addredd.state 	: req.body.state 		,
	    address.zip     : req.body.zip 			,
		credit		    : req.body.credit 		,
	    credExpDate	    : req.body.credExpDate  , // "2017-11-25T00:00:00.000Z"
	    model 		    : req.body.model 		, // ['seller', 'buyer'], 
	    created 	    : req.body.credExpDate	, // "2017-11-25T00:00:00.000Z"
